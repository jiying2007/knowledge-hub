...
summary_zh: 记录 Firmware Toolchains 的结构成熟度、本机 source 发现流程和工程/设备及发布验证待办；owner_ref 已绑定，源码可定位与 owner 确认仍不等于验证完成。
...
- [x] 项目 route matrix 能将 `firmware-toolchains` 稳定解析为本项目。
