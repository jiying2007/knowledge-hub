---
id: agent-dev-kit-readiness-profile-20260713
title: Agent Dev Kit 项目画像候选
...
summary_zh: 记录 Agent Dev Kit 的 registry 身份、仓库边界、已有 Hub 证据和权威边界；只作 reviewing 工作台，不声明源码或发布事实。
promotion_decision: none; owner boundary attested, no active promotion or evidence-ready claim
path: projects/agent-dev-kit/current/project-profile.md
project_id: agent-dev-kit
readiness_slot: profile
aliases:
- agent-dev-kit profile
- agent-dev-kit-profile
related:
- projects/agent-dev-kit/README.md
- projects/agent-dev-kit/current/runbooks/maintenance-entry.md
- projects/agent-dev-kit/decisions/project-boundary-decision-candidate.md
- projects/agent-dev-kit/validation/project-readiness.md
---

# Agent Dev Kit 项目画像候选
...
|---|---|---|---|
| `agent-dev-kit` | `jiying2007/agent-dev-kit` | `workspace://agent-dev-kit` | `first-party` |
...
- [Agent Dev Kit readiness validation](../validation/project-readiness.md)：`reviewing` / `validation`
- [Agent Dev Kit 权威与维护边界决策候选](../decisions/project-boundary-decision-candidate.md)：`reviewing` / `decision`
- [Agent Dev Kit 维护入口](runbooks/maintenance-entry.md)：`reviewing` / `runbook`
- [Agent Dev Kit 项目画像候选](project-profile.md)：`reviewing` / `project-current`
