---
id: app-main-readiness-profile-20260713
title: PCR02 Main App 项目画像候选
...
summary_zh: 记录 PCR02 Main App 的 registry 身份、仓库边界、已有 Hub 证据和权威边界；只作 reviewing 工作台，不声明源码或发布事实。
promotion_decision: none; owner boundary attested, no active promotion or evidence-ready claim
path: projects/app-main/current/project-profile.md
project_id: app-main
...
- projects/app-main/current/runbooks/maintenance-entry.md
- projects/app-main/decisions/project-boundary-decision-candidate.md
- projects/app-main/validation/project-readiness.md
---

# PCR02 Main App 项目画像候选
...
- [PCR02 Main App readiness validation](../validation/project-readiness.md)：`reviewing` / `validation`
- [PCR02 Main App 权威与维护边界决策候选](../decisions/project-boundary-decision-candidate.md)：`reviewing` / `decision`
- [PCR02 Main App 维护入口](runbooks/maintenance-entry.md)：`reviewing` / `runbook`
- [PCR02 Main App 项目画像候选](project-profile.md)：`reviewing` / `project-current`
