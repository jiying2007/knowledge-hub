---
id: gd32l235-readiness-profile-20260713
title: GD32L235 Firmware 项目画像候选
...
- [GD32L235 Firmware readiness validation](../validation/project-readiness.md)：`reviewing` / `validation`
- [GD32L235 Firmware 权威与维护边界决策候选](../decisions/project-boundary-decision-candidate.md)：`reviewing` / `decision`
- [GD32L235 Firmware 维护入口](runbooks/maintenance-entry.md)：`reviewing` / `runbook`
- [GD32L235 Firmware 项目画像候选](project-profile.md)：`reviewing` / `project-current`
- [GD32L235 PA12 快慢充控制与硬件兼容性归档](../archive/pa12-fast-slow-charge-compatibility-20260713.md)：`reviewing` / `project-archive`
