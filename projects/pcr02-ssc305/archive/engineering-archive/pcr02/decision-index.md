...
| `/customer` intermittent read corruption | SquashFS/static volume reduces writable filesystem risk but does not prove the SPI-NAND read path is healthy; 24M FSP QSPI downclock still reproduced the issue and should not be retained as a fix | [customer SquashFS, overlay, and flash-read note](ubifs-squashfs/pcr02_customer_squashfs_overlay_flash_read_20260606.md) |
