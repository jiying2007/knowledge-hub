...
若工具链路径变化，先更新 `projects/xcrz-sigmastar-demo/current/runbooks/project-debug-tools-guide.md` 和 `domains/embedded/skills/offline-gdb-core-debug/SKILL.md`，再同步 Codex managed skill 源文件。
