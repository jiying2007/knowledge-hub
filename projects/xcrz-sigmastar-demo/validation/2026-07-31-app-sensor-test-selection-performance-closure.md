---
id: app-sensor-test-selection-performance-closure-20260731
title: app_sensor_test 选择完整性、构建身份与性能门禁验证
kind: validation
domain: projects/xcrz-sigmastar-demo
path: projects/xcrz-sigmastar-demo/validation/2026-07-31-app-sensor-test-selection-performance-closure.md
...
source:
  ...
  source_sha256: 3f92aee2adb3a6148f495383eaa233f4cecc29952e7eb59fa85f1ef7642e71f9
...
- validation
validation_refs:
- projects/xcrz-sigmastar-demo/validation/2026-07-31-app-sensor-test-selection-performance-closure.md
...
summary_zh: app_sensor_test 源码侧补齐 selection coverage 防漏跑、HIL 独立复算、dirty 构建身份及 latency/CPU 性能预算；source-gate 通过，Board/HIL、TSan
  环境和 Git 纳管仍待闭环。
...
aliases:
- app_sensor_test 选择完整性、构建身份与性能门禁验证
related:
...
| HIL bundle validator（13 tests） | PASS |
...
- size：88,037,032 bytes
- build time：`2026-07-31 10:06:35 +0800`
- BuildID：`c3a3353d44be238c6a0d154adde0f93a400515f0`
- SHA-256：`37c5bef31961aa0116155979922269d5c5d6a611343bda72518cafc922205b6b`
- MD5：`f4ae0c7bc9130d0f83e04cdef9014fb1`
