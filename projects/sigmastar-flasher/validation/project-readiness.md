---
id: sigmastar-flasher-readiness-validation-20260713
title: SigmaStar Flasher readiness validation
kind: validation
...
# SigmaStar Flasher readiness validation
...
- [x] 30 项目 route matrix 能将 `sigmastar-flasher` 稳定解析为本项目。
