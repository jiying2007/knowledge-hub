---
id: pcr02-readiness-decision-20260713
title: PCR02 权威与维护边界决策候选
kind: decision
...
summary_zh: 为 PCR02 提供 source/Hub/Obsidian 权威分工的 owner-review 候选；decision owner 尚未指定，当前没有生效决定。
promotion_decision: none; structural readiness asset only, no active promotion or owner decision
path: projects/pcr02/decisions/project-boundary-decision-candidate.md
project_id: pcr02
