...
|---|---:|---|---|---|---|
| `rtk bash tools/knowledge-regression.sh --json` | 0 | 通过；20 个回归场景全部 pass，覆盖人工新增 owner 文档和 help 可发现性 | `tools/knowledge-regression.sh` | Tool | `knowledge-hub-manual-entry-owner-doc-sync-20260619` |
