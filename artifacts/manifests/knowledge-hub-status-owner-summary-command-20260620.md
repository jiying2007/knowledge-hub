...
| `rtk bash tools/knowledge-regression.sh --json` | 0 | 通过；18 个回归场景全部 pass，`status-next-owner-gate` 覆盖 summary command 和 next-open command | `tools/knowledge-regression.sh` | Tool | `knowledge-hub-status-owner-summary-command-20260620` |
