...
| `rtk bash tools/knowledge-regression.sh --json` | 0 | 通过；16 个回归场景全部 pass，包含 `owner-next-open-focus` | `tools/knowledge-regression.sh` | Tool | `knowledge-hub-owner-next-open-helper-20260619` |
