...
| `rtk bash tools/knowledge-regression.sh --json` | 0 | 通过；16 个回归场景全部 pass，包含 `owner-form-context` | `tools/knowledge-regression.sh` | Tool | `knowledge-hub-owner-form-context-20260619` |
