...
| `rtk bash tools/knowledge-regression.sh --json` | 0 | 通过；20 个回归场景全部 pass，包含 `status-next-owner-gate` 场景 | `tools/knowledge-regression.sh` | Tool | `knowledge-hub-status-next-owner-gate-20260619` |
