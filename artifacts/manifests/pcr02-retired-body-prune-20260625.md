...
- 保留必要治理证据：`sources/<source_id>/`、`registry/sources.json`、`registry/sources.json`、`registry/items.jsonl`、source canonicalization manifest、owner decision manifest 和本剪枝账本。
