...
| `rtk bash tools/knowledge-regression.sh --json` | 0 | 通过；14 个回归场景全部 pass，包含 `owner-checklist-context` | `tools/knowledge-regression.sh` | Tool | `knowledge-hub-owner-checklist-helper-20260619` |
