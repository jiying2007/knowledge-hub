...
| `rtk bash tools/knowledge-regression.sh --json` | 0 | 通过；18 个回归场景全部 pass，包含 `owner-summary-all-open` | `tools/knowledge-regression.sh` | Tool | `knowledge-hub-owner-summary-helper-20260620` |
