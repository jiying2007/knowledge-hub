...
| final-gate-mature-review-queue-owner-review-blocker | mature final gate 对普通 AI/外部资料待复核队列执行 owner-review 阻断 | `knowledge-final-gate --final-profile mature` 必须返回 `needs-owner-review`，`review_queue_recovery.owner_review_blocking=true`，Evidence Index 标记 `review-queue-recovery=owner-review`，gap map 不得把该阻断标为 Codex 可自动完成 |
