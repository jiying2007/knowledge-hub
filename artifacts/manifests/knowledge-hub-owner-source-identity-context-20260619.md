...
| `rtk bash tools/knowledge-regression.sh --json` | 0 | 通过；17 个回归场景全部 pass，包含 `owner-source-identity-context` | `tools/knowledge-regression.sh` | Tool | `knowledge-hub-owner-source-identity-context-20260619` |
