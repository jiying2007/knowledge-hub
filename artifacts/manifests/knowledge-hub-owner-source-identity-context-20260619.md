...
| `rtk bash tools/knowledge-regression.sh --json` | 0 | 通过；20 个回归场景全部 pass，包含 `owner-source-identity-context` 和 `owner-form-source-identity-mismatch` | `tools/knowledge-regression.sh` | Tool | `knowledge-hub-owner-source-identity-context-20260619` |
