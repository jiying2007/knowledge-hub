...
| `rtk bash tools/knowledge-regression.sh --json` | 0 | 通过；16 个回归场景全部 pass，`status-next-owner-gate` 覆盖 checklist/forms 聚焦命令 | `tools/knowledge-regression.sh` | Tool | `knowledge-hub-status-owner-checklist-focus-20260619` |
