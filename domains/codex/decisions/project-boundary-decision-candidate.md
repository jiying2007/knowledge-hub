---
id: codex-readiness-decision-20260713
title: Codex Local Runtime Assets 权威与维护边界决策候选
kind: decision
domain: codex
scope: team-general
...
summary_zh: 为 Codex Local Runtime Assets 记录 hash-bound owner attestation 已接受 source/Hub/Obsidian 权威分工；候选继续 reviewing，真实验证与发布证据仍待补齐。
promotion_decision: none; owner boundary attested, no active promotion or evidence-ready claim
path: domains/codex/decisions/project-boundary-decision-candidate.md
project_id: codex
...
# Codex Local Runtime Assets 权威与维护边界决策候选
