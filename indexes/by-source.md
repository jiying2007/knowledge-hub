...
- `codex-archive/debug-notes/20260516-222503-windows-builder-runbook.md`: 已迁移为 llm_tools Windows builder runbook，旧正文已按授权删除并保留 tombstone：`artifacts/manifests/codex-archive-removal-execution-20260710-migrated-extract-first.md`。
