---
id: knowledge-hub-readiness-decision-20260713
title: Knowledge Hub 权威与维护边界决策候选
kind: decision
domain: governance
scope: team-general
...
summary_zh: 为 Knowledge Hub 记录 hash-bound owner attestation 已接受 source/Hub/Obsidian 权威分工；候选继续 reviewing，真实验证与发布证据仍待补齐。
promotion_decision: none; owner boundary attested, no active promotion or evidence-ready claim
path: governance/product/decisions/project-boundary-decision-candidate.md
project_id: knowledge-hub
readiness_slot: decision
aliases:
- knowledge-hub decision
- knowledge-hub-decision
related:
- README.md
