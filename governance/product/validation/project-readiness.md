...
title: Knowledge Hub readiness validation
kind: validation
domain: governance
scope: team-general
...
summary_zh: 记录 Knowledge Hub 的结构成熟度、本机 source 发现流程和真实 owner、工程/设备及发布验证待办；源码可定位不等于验证完成。
...
# Knowledge Hub readiness validation
...
- [x] 31 项目 route matrix 能将 `knowledge-hub` 稳定解析为本项目。
